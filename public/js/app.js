...
var alertMsg = document.getElementById("sucess-alert");
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    ...
    if (dataProp === order.status) {
      stepCompleted = false;
      time.innerText = moment__WEBPACK_IMPORTED_MODULE_3___default()(order.upadtedAt).format('hh:mm A');
...
socket.on('orderUpdated', function (data) {
  ...
  updatedOrder.upadtedAt = moment__WEBPACK_IMPORTED_MODULE_3___default()().format();
...
__webpack_require__(/*! C:\Users\Arun\desktop\project\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\Arun\desktop\project\resources\scss\app.scss */"./resources/scss/app.scss");
